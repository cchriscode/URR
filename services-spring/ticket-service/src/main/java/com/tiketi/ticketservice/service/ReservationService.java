...
import com.tiketi.ticketservice.dto.CreateReservationRequest;
import com.tiketi.ticketservice.dto.ReservationItemRequest;
...
public class ReservationService {
    ...
    public Map<String, Object> cancelReservation(String userId, UUID reservationId) {
        ...
        jdbcTemplate.update("UPDATE reservations SET status = 'cancelled', payment_status = 'refunded', updated_at = NOW() WHERE id = ?",
            reservationId);
