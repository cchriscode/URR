...
import com.tiketi.ticketservice.dto.NewsCreateRequest;
import com.tiketi.ticketservice.dto.NewsUpdateRequest;
...
public class NewsService {
    ...
    public NewsService(JdbcTemplate jdbcTemplate, MembershipService membershipService) {
    ...
    public Map<String, Object> create(NewsCreateRequest request, AuthUser user) {
        UUID authorId = request.authorId() != null ? request.authorId() : UUID.fromString(user.userId());
        ...
        // Award membership points for news creation
        try {
