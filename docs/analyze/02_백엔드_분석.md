...
각 서비스에 2개의 설정 클래스를 추가:

```
shared/config/
├── ReadWriteRoutingDataSource.java   ← AbstractRoutingDataSource 확장
└── DataSourceRoutingConfig.java      ← Primary/Replica HikariDataSource + 라우팅 빈
```
...
| # | 파일 | 작업 |
|---|------|------|
| 1 | `catalog-service/shared/config/ReadWriteRoutingDataSource.java` | 신규 |
| 2 | `catalog-service/shared/config/DataSourceRoutingConfig.java` | 신규 |
...
| 5 | `stats-service/shared/config/ReadWriteRoutingDataSource.java` | 신규 |
| 6 | `stats-service/shared/config/DataSourceRoutingConfig.java` | 신규 |
| 7 | `stats-service/application.yml` | `replica-url` 프로퍼티 추가 |
| 8 | `stats-service/StatsQueryService.java` | 클래스 레벨 `@Transactional(readOnly = true)` |
| 9 | `community-service/shared/config/ReadWriteRoutingDataSource.java` | 신규 |
| 10 | `community-service/shared/config/DataSourceRoutingConfig.java` | 신규 |
| 11 | `community-service/application.yml` | `replica-url` 프로퍼티 추가 |
| 12 | `community-service/PostService.java` | `list()` 메서드 레벨 어노테이션 |
| 13 | `community-service/CommentService.java` | `listByPost()` 메서드 레벨 어노테이션 |
| 14 | `community-service/NewsService.java` | `list()` 메서드 레벨 어노테이션 |
